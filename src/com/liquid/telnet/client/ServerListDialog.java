...
import com.liquid.telnet.client.LiquidMudClientActivity.ServerInfo;
...
public class ServerListDialog extends Dialog {
    ...
    private void setupAlerts() {
        ...
        .setPositiveButton(Messages.getString("ServerListDialog.4"), new DialogInterface.OnClickListener() { //$NON-NLS-1$
                public void onClick(DialogInterface dialog, int whichButton) {
                        cready.modify(contextSelect);
                        ServerListDialog.this.dismiss();
                }
        })
        .setNeutralButton(Messages.getString("ServerListDialog.5"), new DialogInterface.OnClickListener() { //$NON-NLS-1$
                public void onClick(DialogInterface dialog, int whichButton) {
                        cready.connect(contextSelect);
                        ServerListDialog.this.dismiss();
                }
        })
        .setNegativeButton(Messages.getString("ServerListDialog.6"), new DialogInterface.OnClickListener() { //$NON-NLS-1$
                public void onClick(DialogInterface dialog, int whichButton) {
